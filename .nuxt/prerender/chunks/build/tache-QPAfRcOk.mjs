import { ref, watch, mergeProps, withCtx, createVNode, unref, createBlock, createCommentVNode, openBlock, toDisplayString, withModifiers, withDirectives, vModelText, Fragment, renderList, useSSRContext } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlotInner } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useMutation, a as useQuery, _ as _export_sfc } from './server.mjs';
...
`;
    ...
    const handleAddTache = async () => {
      ...
      try {
        ...
        console.error("Erreur lors de l'ajout de la t\xE2che:", err);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AnimatedTransition, { transitionName: "fade" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-2xl font-bold text-red-600 underline text-center mb-8"${_scopeId}>Gestion des t\xE2ches</h1>`);
          } else {
            return [
              createVNode("h1", { class: "text-2xl font-bold text-red-600 underline text-center mb-8" }, "Gestion des t\xE2ches")
            ];
          }
        }),
        _: 1
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "bg-white rounded-lg shadow-md p-6 mb-8" }, [
                createVNode("h2", { class: "text-xl font-semibold mb-4" }, "Ajouter une t\xE2che"),
                createVNode("form", {
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Propri\xE9taire:"),
                      withDirectives(createVNode("input", {
                        "onUpdate:modelValue": ($event) => owner.value = $event,
                        type: "text",
                        placeholder: "Propri\xE9taire",
                        class: "w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-slate-600 transition-all duration-200",
                        required: ""
                      }, null, 8, ["onUpdate:modelValue"]), [
      ...
      _push(ssrRenderComponent(AnimatedTransition, { transitionName: "slide" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-white rounded-lg shadow-md p-6"${_scopeId}><h2 class="text-xl font-semibold mb-4"${_scopeId}>Liste des t\xE2ches</h2><div class="text-center py-4"${_scopeId}>`);
            _push2(ssrRenderComponent(AnimatedTransition, { transitionName: "fade" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (loading.value) {
                    ...
                    _push3(`<div class="text-center py-4"${_scopeId2}><p class="text-gray-500"${_scopeId2}>Aucune t\xE2che trouv\xE9e.</p></div>`);
                  } else {
                    _push3(ssrRenderComponent(AnimatedTransition, { transitionName: "slide" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="overflow-x-auto"${_scopeId3}><table class="min-w-full divide-y divide-gray-200"${_scopeId3}><thead class="bg-gray-50"${_scopeId3}><tr${_scopeId3}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId3}>Propri\xE9taire</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId3}>T\xE2che</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId3}>Description</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId3}>Statut</th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId3}><!--[-->`);
                                  ...
                                  _push5(ssrRenderComponent(AnimatedTransition, { transitionName: "fade" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        ...
                                        ])}"${_scopeId5}>${ssrInterpolate(tache.completed ? "Termin\xE9e" : "En cours")}</span>`);
                                      } else {
                                        return [
                                          createVNode("span", {
                                            class: [
                                          ...
                                          }, toDisplayString(tache.completed ? "Termin\xE9e" : "En cours"), 3)
                                        ];
                                      }
                                    }),
                                    _: 2
                            ...
                            createVNode("div", { class: "overflow-x-auto" }, [
                              createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                                createVNode("thead", { class: "bg-gray-50" }, [
                                  createVNode("tr", null, [
                                    createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Propri\xE9taire"),
                                    createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "T\xE2che"),
                  ...
                  return [
                    loading.value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("p", { class: "text-gray-500" }, "Aucune t\xE2che trouv\xE9e.")
            ...
            return [
              createVNode("div", { class: "bg-white rounded-lg shadow-md p-6" }, [
                createVNode("h2", { class: "text-xl font-semibold mb-4" }, "Liste des t\xE2ches"),
...
//# sourceMappingURL=tache-QPAfRcOk.mjs.map
