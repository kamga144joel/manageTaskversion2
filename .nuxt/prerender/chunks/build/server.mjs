...
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/h3/dist/index.mjs';
import { shouldHydrate, createPinia, setActivePinia, defineStore } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/pinia/dist/pinia.prod.cjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$1, RouterView } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/ufo/dist/index.mjs';
import { invariant as invariant$1, InvariantError } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/ts-invariant/lib/invariant.cjs';
import { Observable } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/zen-observable-ts/index.cjs';
import { visit, BREAK, print as print$1, Kind, isSelectionNode } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/graphql/index.js';
import { WeakCache, StrongCache } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/@wry/caches/lib/bundle.cjs';
import { createApolloProvider } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/@vue/apollo-option/dist/vue-apollo-option.esm.mjs';
...
import { isEqual, hash } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { klona } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/klona/dist/index.mjs';
import { Slot, wrap as wrap$1, dep } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/optimism/lib/bundle.cjs';
import equal, { equal as equal$1 } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/@wry/equality/lib/bundle.cjs';
import { Trie } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/@wry/trie/lib/bundle.cjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/bomberkiller/Desktop/monsite/todo-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "tache",
    path: "/tache",
    component: () => import('./tache.vue.mjs')
  },
  {
    name: "theme",
    path: "/theme",
    component: () => import('./theme.vue.mjs')
  },
  {
    name: "bascule",
    path: "/bascule",
    component: () => import('./bascule.vue.mjs')
  },
  {
    name: "courcss",
    path: "/courcss",
    component: () => import('./courcss.vue.mjs')
  },
  {
    name: "profile",
    path: "/profile",
  ...
  },
  {
    name: "taiwind",
    path: "/taiwind",
    component: () => import('./taiwind.vue.mjs')
  },
  {
    name: "infolink",
    path: "/infolink",
    component: () => import('./infolink.vue.mjs')
  },
  {
    name: "menutcss",
    path: "/menutcss",
    component: () => import('./menutcss.vue.mjs')
  },
  {
    name: "component",
    path: "/component",
    component: () => import('./component.vue.mjs')
  },
  {
    name: "detailWeb",
    path: "/detailWeb",
    component: () => import('./detailWeb.vue.mjs')
  },
  {
    name: "Inscription",
    path: "/Inscription",
    component: () => import('./Inscription.vue.mjs')
  }
];
...
var QueryInfo = (
  ...
  function() {
    ...
    QueryInfo2.prototype.setDiff = function(diff) {
      ...
      if (!equal$1(oldDiff && oldDiff.result, diff && diff.result)) {
...
export { _export_sfc as _, __nuxt_component_0 as a, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useMutation as u };
