...
import { ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderAttrs, ssrRenderComponent } from "vue/server-renderer";
...
`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button></div></nav><div class="flex-grow flex items-center justify-center p-6" data-v-d6e967bd><div class="bg-white text-black shadow-lg rounded-lg p-8 w-full max-w-md" data-v-d6e967bd><h1 class="underline font-bold text-center mb-4 text-green-600" data-v-d6e967bd> Bienvenue sur notre site Web </h1><h2 class="text-center text-gray-700 mb-6" data-v-d6e967bd> Connectez-vous pour bénéficier de nos services </h2><h2 class="bg-red-700" data-v-d6e967bd>vous n&#39;avez pas de conte MANAGETASKS??? c&#39;est pas grave!!!<a href="/inscription" class="underline" data-v-d6e967bd>créez-en</a></h2>`);
      if (unref(loading)) {
      ...
      _push(`</div></div><div class="bg-blue-lightest border-t border-b border-blue text-blue-dark px-4 py-3" role="alert" data-v-d6e967bd><p class="font-bold" data-v-d6e967bd>Message d&#39;information</p><p class="text-sm" data-v-d6e967bd> Quelques textes supplémentaires pour expliquer ledit message..</p></div><p class="text-center text-yellow-900 text-xs" data-v-d6e967bd> ©2020 Acme Corp. All rights reserved. </p></div><!--]-->`);
    };
  }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mt-16"><h2 class="text-3xl font-bold text-center mb-8">Pourquoi MANAGETASKS ?</h2><div class="grid grid-cols-1 md:grid-cols-3 gap-8"><div class="p-6 bg-white rounded-lg shadow-sm"><h3 class="text-xl font-semibold mb-3">Collaboratif</h3><p class="text-gray-600">Gérez vos tâches en équipe avec nos outils de collaboration en temps réel.</p></div><div class="p-6 bg-white rounded-lg shadow-sm"><h3 class="text-xl font-semibold mb-3">Organisé</h3><p class="text-gray-600">Suivez l&#39;avancement de vos projets grâce à nos tableaux et filtres avancés.</p></div><div class="p-6 bg-white rounded-lg shadow-sm"><h3 class="text-xl font-semibold mb-3">Simple</h3><p class="text-gray-600">Interface intuitive et facile à utiliser, accessible à tous.</p></div></div></div><div class="mt-16 text-center text-gray-500 text-sm"> © 2025 MANAGETASKS. Tous droits réservés. </div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-xWPxnvjH.js.map
